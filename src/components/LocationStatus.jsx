...
export default function SearchStatusComponent(func) {
  ...
  : <p className='flex items-center gap-4 '><svg xmlns="http://www.w3.org/2000/svg" className = {'text-blue-500 '} width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 3l-6.5 18a.55.55 0 0 1-1 0L10 14l-7-3.5a.55.55 0 0 1 0-1L21 3"/></svg>Click to Search</p> 
  }
    </div>
